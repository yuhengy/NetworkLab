...
if __name__ == '__main__':
    ...
    #r1.cmd('stdbuf -oL -eL ./src/router > result/STEP2-router1.txt 2>&1 &')
    #r2.cmd('stdbuf -oL -eL ./src/router > result/STEP2-router2.txt 2>&1 &')
    ...
    h1.cmd('echo \'***********************************\' > result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'**************ttl = 1**************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'***********************************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('ping -c 1 -t 1 10.0.2.22 >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'***********************************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'**************ttl = 2**************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'***********************************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('ping -c 1 -t 2 10.0.2.22 >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'***********************************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'**************ttl = 3**************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('echo \'***********************************\' >> result/STEP2c-tracerouteH2.txt 2>&1')
    h1.cmd('ping -c 1 -t 3 10.0.2.22 >> result/STEP2c-tracerouteH2.txt 2>&1')
    time.sleep(1)
