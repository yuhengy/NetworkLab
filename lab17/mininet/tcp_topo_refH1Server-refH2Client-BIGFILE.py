...
if __name__ == '__main__':
    ...
    h1.cmd("python build/tcp_stack-BIGFILE.py server 10001 > result/STEP4-refH1Server.txt 2>&1 &")
    #h1.cmd("stdbuf -oL -eL ./build/tcp_stack server 10001 > result/STEP4-refH1Server.txt 2>&1 &")
    time.sleep(1)
    h2.cmd("python build/tcp_stack-BIGFILE.py client 10.0.0.1 10001 > result/STEP4-refH2Client.txt 2>&1 &")
    #h2.cmd("stdbuf -oL -eL ./build/tcp_stack client 0x0a000001 10001 > result/STEP4-refH2Client.txt 2>&1 &")
    time.sleep(39)

    h1.cmd('mv /STEP4-wiresharkOutput-refH1Server.pcapng result/')
    h2.cmd('mv /STEP4-wiresharkOutput-refH2Client.pcapng result/')
    h2.cmd('diff mininet/client-input.dat mininet/server-output.dat > result/STEP4-diff.txt 2>&1')
