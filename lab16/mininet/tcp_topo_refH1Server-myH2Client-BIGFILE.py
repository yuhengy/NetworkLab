...
if __name__ == '__main__':
    ...
    net.start()
    #CLI(net)
    h1.cmd('tshark -a duration:30 -w /STEP7-wiresharkOutput-refH1Server.pcapng > result/STEP7-tsharkOutput-refH1Server.log 2>&1 &')
    h2.cmd('tshark -a duration:30 -w /STEP7-wiresharkOutput-myH2Client.pcapng > result/STEP7-tsharkOutput-myH2Client.log 2>&1 &')
    time.sleep(20)

    h1.cmd("stdbuf -oL -eL python build/tcp_stack-BIGFILE.py server 10001 > result/STEP7-refH1Server.txt 2>&1 &")
    #h1.cmd("stdbuf -oL -eL ./build/tcp_stack server 10001 > result/STEP7-myH1Server.txt 2>&1 &")
    time.sleep(1)
    #h2.cmd("python build/tcp_stack-BIGFILE.py client 10.0.0.1 10001 > result/STEP7-refH2Client.txt 2>&1 &")
    h2.cmd("stdbuf -oL -eL ./build/tcp_stack client 0x0a000001 10001 > result/STEP7-myH2Client.txt 2>&1 &")
    time.sleep(39)
