...
if __name__ == '__main__':
    ...
    #h1.cmd("python build/tcp_stack.py server 10001 > result/STEP2-refH1Server.txt 2>&1 &")
    h1.cmd("stdbuf -oL -eL ./build/tcp_stack server 10001 > result/STEP2-myH1Server.txt 2>&1 &")
    time.sleep(1)
    h2.cmd("python build/tcp_stack.py client 10.0.0.1 10001 > result/STEP2-refH2Client.txt 2>&1 &")
