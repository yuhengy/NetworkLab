...
if __name__ == '__main__':
    ...
    #h1.cmd("python build/tcp_stack.py server 10001 > result/STEP2-myH1Server.txt 2>&1 &")
    ...
    #h2.cmd("stdbuf -oL -eL ./build/tcp_stack client 0x0a000001 10001 > result/STEP2-refH2Client.txt 2>&1 &")
    time.sleep(39)
