...
if __name__ == '__main__':
    ...
    time.sleep(1)
    h3.cmd("wget http://159.226.39.123:8000 -O result/STEP1-h1client-index.html > result/STEP1-h1client.txt 2>&1 &")
    h3.cmd("wget http://159.226.39.123:8000 -O result/STEP1-h2client-index.html > result/STEP1-h2client.txt 2>&1 &")
